<template>
  <div style="margin-bottom: 8%">
    ...
    <div class="cell">
      ...
      <textarea type="text" v-model="content" placeholder="原文"   ></textarea>
    </div>
    <div class="cell">
      <div class="tip">
        <div>感想</div>
        ...
        <input type="file" accept="image/*" ref="review" @change="addContent(1)">
      </div>
      <textarea type="text" v-model="review" placeholder="感想" ></textarea>
    </div>
  </div>
</template>
